...
export default function BannerSlider() {
  ...
  return (
    <Slider {...settings}>
      ...
      <div className='home-banner-img'>
      <Link href={'/'}>
      <img src={"assets/images/banner_4_mob.webp"} alt="banner-1" height={'100%'} width={'100%'} className='d-block d-sm-none' />
        <img src={"assets/images/banner_4.webp"} alt="banner-1" height={'100%'} width={'100%'} className='d-none d-sm-block' />
        </Link>
      </div>
    </Slider>
  );
