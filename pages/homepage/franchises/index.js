  ...
  return (
    ...
    <div className="franch-ban">
        ...
        <div className="about-franch">
            <h1>EVERY THING <br></br>ABOUT FRANCHISING</h1>
        ...
        <div className="franch-cost">
            ...
            <p>*City, District, State level master Franchise * Low Investment (10 Lacs - 15 Lacs) <br /> *High Returns (upto 50 Thousand Monthly)</p>
        </div>
